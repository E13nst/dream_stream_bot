...
--
-- ВАЖНО: Эта миграция безопасна для существующих таблиц.
-- Все команды используют IF NOT EXISTS, поэтому существующие таблицы
-- (bot, users, chat_memory) и их данные не будут изменены.
