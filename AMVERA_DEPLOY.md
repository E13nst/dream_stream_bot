...
**Резюме:**  
На Amvera всегда происходит чистая сборка при деплое, и все зависимости подтягиваются автоматически. Главное — чтобы изменения были в репозитории, а pom.xml был актуален.

Если что-то не работает — проверьте логи сборки и убедитесь, что переменные окружения и конфиги заданы корректно.
